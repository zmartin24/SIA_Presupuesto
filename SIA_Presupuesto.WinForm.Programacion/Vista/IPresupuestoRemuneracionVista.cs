...
{
    public interface IPresupuestoRemuneracionVista : IControlDetalleBaseVista
    {
        List<CalculoPresupuestoRemuneracion> listaDatosPrincipales { set; }
        List<PuestoPresupuesto> puestoPresupuestos { get; }
