...
namespace SIA_Presupuesto.WebForm.Helper
{
    public class PredeterminadoHelper
    {
        ...
        public static List<Predeterminado> ListarTipoReportePac()
        {
            ...
            //lista.Add(new Predeterminado { codigo = "03", descripcion = "PLAN ANUAL DE CONTRATACIONES RESUMEN" });
        ...
        {
            List<Predeterminado> lista = new List<Predeterminado>();
            lista.Add(new Predeterminado { codigo = "03", descripcion = "ORDEN COMPRA & SERVICIO COMPROMETIDAS" });
            lista.Add(new Predeterminado { codigo = "04", descripcion = "ORDEN COMPRA & SERVICIO COMPROMETIDAS POR PRESUPUESTO" });
            lista.Add(new Predeterminado { codigo = "05", descripcion = "ORDEN COMPRA & SERVICIO EJECUTADAS POR PRESUPUESTO" });
        ...
        public static List<Predeterminado> ListaAnio()
        {
            List<Predeterminado> lista = new List<Predeterminado>();
            int vanioi = 2018;
