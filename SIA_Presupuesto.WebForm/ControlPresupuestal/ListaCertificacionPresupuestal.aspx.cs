...
{
    public partial class ListaCertificacionPresupuestal : System.Web.UI.Page//, IListaCertificacionPresupuestalVista
    {
        ...
        public List<CertificacionRequerimiento> listaDatosPrincipales
        {
            set
            {
        ...
        {
            listaCertificacionPresupuestalPresentador = null;//new ListaCertificacionPresupuestalPresentador(this);
        ...
        protected void btnDetalle_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect(string.Format("ListaCertificacionDetalles.aspx?idCerReq={0}", idCerReq));
            }
            
        }

        protected void popReporteDireccion_WindowCallback(object source, DevExpress.Web.PopupWindowCallbackArgs e)
        {
            //listaCertificacionPresupuestalPresentador.IniciarReporte(0);
        }
