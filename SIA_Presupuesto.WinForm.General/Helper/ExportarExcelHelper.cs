    ...
    public class ExportarExcelHelper
    {
        ...
        public void GenerarTitulo(IXlSheet hoja, string vtitulo, int cantColumnas)
        {
            ...
            using (IXlRow row = hoja.CreateRow())
            {
                ...
                {
                    cell.Value = vtitulo != null ? vtitulo.ToUpper() : string.Empty;
        ...
        public void GenerarCabeceraFilasVariasCombinar(IXlSheet hoja, IEnumerable<string> nombreColumnas, IEnumerable<int> posColumnasCombinacion, int incremento, int vpos_top_button, int cantCombinar)
        {
            using (IXlRow row = hoja.CreateRow())
            {
                foreach (string columnName in nombreColumnas)
            ...
            foreach (int pos in posColumnasCombinacion)
            {
                hoja.MergedCells.Add(XlCellRange.FromLTRB(pos + incremento, vpos_top_button, pos + incremento, vpos_top_button + cantCombinar));
            }

        }
        public void CombinaListaCeldas(IXlSheet hoja, IEnumerable<int> listaPosColCombinacion, int vpos_top_button, int incrementoRight, int incrementoButton)
        {
            foreach (int pos in listaPosColCombinacion)
            {
                hoja.MergedCells.Add(XlCellRange.FromLTRB(pos, vpos_top_button, pos + incrementoRight, vpos_top_button + incrementoButton));
            }
        }

        public void GenerarCabeceraColumnasVariasCombinar(IXlSheet hoja, IEnumerable<string> nombreColumnas, IEnumerable<int> posColumnasCombinacion, int incremento, int vpos_top_button, int cantCombinar)
        {
            using (IXlRow row = hoja.CreateRow())
            {
                foreach (string columnName in nombreColumnas)
            ...
            foreach (int pos in posColumnasCombinacion)
            {
                hoja.MergedCells.Add(XlCellRange.FromLTRB(pos + incremento , vpos_top_button, pos + incremento + cantCombinar, vpos_top_button));
            }

        }

        public void GenerarCabeceraColumnasVariasCombinarInicioVariable(IXlSheet hoja, IEnumerable<string> nombreColumnas, IEnumerable<int> posColumnasCombinacion, int columnaInicio, int vpos_top_button, int cantCombinar)
        {
            using (IXlRow row = hoja.CreateRow())
            {
                foreach (string columnName in nombreColumnas)
            ...
            foreach (int pos in posColumnasCombinacion)
            {
                hoja.MergedCells.Add(XlCellRange.FromLTRB(pos, vpos_top_button, pos + cantCombinar, vpos_top_button));
            }
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        switch (celda.tipoDato)
                        {
                            ...
                            case TipoDatoExportar.Fecha:
                                ...
                                break;
                            case TipoDatoExportar.FechaHora:
                                XlNumberFormat fechaHoraFormat = @"dd/MM/yyyy hh:mm:ss";
                                cell.Value = Convert.ToDateTime(celda.valor);
                                cell.Formatting = fechaHoraFormat;
                                break;
                        }
                        ...
                        if (celda.formulaString != null)
                            cell.SetFormula(celda.formulaString);
        ...
        public void GenerarDatosFilaCombinaColumnaInicioVariable(IXlSheet hoja, List<CeldaExportar> celdas, IEnumerable<int> posColumnasCombinacion, int tamanioAlto, int vpos_top_button, int cantCombinar)
        {
            using (IXlRow row = hoja.CreateRow())
            {
                row.HeightInPixels = tamanioAlto;
        ...
        public static XlCellFormatting SoloAmarilloLimonColor()
        {
            XlCellFormatting formatoTotal = new XlCellFormatting();
            formatoTotal.Font = new XlFont();
            formatoTotal.Font.Name = "Calibri";
            ...
            formatoTotal.Fill = XlFill.SolidFill(Color.LemonChiffon);
            
            return formatoTotal;
        }

        public static XlCellFormatting SoloVerdeClaro()
        {
            XlCellFormatting formatoTotal = new XlCellFormatting();
            formatoTotal.Font = new XlFont();
            formatoTotal.Font.Name = "Calibri";
            ...
            formatoTotal.Fill = XlFill.SolidFill(Color.PeachPuff);
            //formatoTotal.NumberFormat = XlNumberFormat.NumberWithThousandSeparator2;
        ...
        public static IXlFormulaParameter MultiplicarPorCoordenadasHaciaDerecha(int columnaInicial, int filaInicial, int NroColumnas)
        {
            IXlFormulaParameter numLeft = XlCellRange.FromLTRB(columnaInicial, filaInicial, columnaInicial, filaInicial);
            IXlFormulaParameter numRight = XlCellRange.FromLTRB(NroColumnas, filaInicial, NroColumnas, filaInicial);
           
            return XlOper.Multiply(numLeft, numRight);
        }
